...
artifact_dir = "modelzoo/EBokehNet_s.ckpt"  # Path to the model artifact
...
time_inference = False  # Set to True to measure inference time, only works on GPU
calculate_metrics = False  # Set to True to calculate PSNR only works if GT images are already in the output directory
...
dataloader = get_dataloader(image_in_dir, model)
